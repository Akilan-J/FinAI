    ...
    <div className="bg-neutral-900/20 border border-neutral-800/60 p-5 rounded-2xl space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="relative">
          <Icons.Search className="absolute left-3 top-3.5 w-4 h-4 text-neutral-500" />
          <input
            type="text"
            value={search}
            onChange={(e) => onSearchChange(e.target.value)}
            className="w-full bg-neutral-950/60 border border-neutral-800/80 focus:border-violet-500 rounded-xl pl-9 pr-4 py-2.5 text-sm text-neutral-100 placeholder-neutral-500 outline-none transition"
        ...
        <div>
          <select
            ...
            className="w-full bg-neutral-950/60 border border-neutral-800/80 focus:border-violet-500 rounded-xl px-3.5 py-2.5 text-sm text-neutral-300 outline-none transition cursor-pointer"
          >
